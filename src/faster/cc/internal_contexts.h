...
protected:
    PendingContext(OperationType type_, IAsyncContext &caller_context_,
            ...
            : type{type_}, caller_context{&caller_context_}, caller_callback{caller_callback_},
              version{UINT32_MAX}, phase{Phase::INVALID}, result{Status::Pending},
              address{Address::kInvalidAddress}, entry{HashBucketEntry::kInvalidEntry} {
    }
