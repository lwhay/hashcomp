...
void naiveConciseARCTest() {
    ...
    int keys[100] = {0, 1, 2, 3, 21, 1, 23, 1, 23, 2, 1, 1, 12, 321, 321, 12, 21, 3, 21, 0, 1, 2, 23, 1, 23, 2, 24, 2,
                     1, 15, 21, 123, 122, 1, 123, 1, 23, 1, 0, 3523, 6, 435, 2, 23, 4, 52, 334, 6, 2, 32, 45, 63, 4,
                     123, 123, 21, 34, 23, 3, 324, 32, 432, 43, 24, 324, 32, 432, 4, 324, 324, 12, 6, 54, 6, 546, 3,
                     234, 32, 6, 433, 23, 122, 1, 123, 1, 23, 1, 0, 3523, 6, 435, 2, 23, 4, 52, 334, 6, 2, 32, 45};
    for (int i = 0; i < 100; i++) {
        cout << i << " ";
