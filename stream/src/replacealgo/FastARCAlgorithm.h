...
#ifndef STREAM_FASTARCALGORITHM_H
#define STREAM_FASTARCALGORITHM_H
...
class FastARCAlgorithm {
private:
    enum Adjustment {
        MIN, MAX
    };
    FastLRUAlgorithm<IT> *t1, *t2, *b1, *b2;
    float hitRatio;
...
public:
    FastARCAlgorithm(size_t cacheSize) {
        p = 0;
        numHits = 0;
        numRequests = 0;
        numMisses = 0;
        ...
        t1 = new FastLRUAlgorithm<IT>(cacheSize);
        t2 = new FastLRUAlgorithm<IT>(cacheSize);

        b1 = new FastLRUAlgorithm<IT>(cacheSize);
        b2 = new FastLRUAlgorithm<IT>(cacheSize);
...
#endif //STREAM_FASTARCALGORITHM_H
